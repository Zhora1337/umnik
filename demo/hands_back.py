...
def run_frank_mocap(args, bbox_detector, body_mocap, hand_mocap, visualizer):
    ...
    while True:
        ...
        if hand_bbox_list[0]['right_hand'] is not None and hand_bbox_list[0]['left_hand'] is not None:
            if hand_bbox_list[0]['left_hand'][0] + hand_bbox_list[0]['left_hand'][2] >= hand_bbox_list[0]['right_hand'][0]:
                left_hand_text = right_hand_text = 'right_hand accross left_hand'
                show_touched = True
        ...
        if show_touched:
            cv2.putText(res_img, 'TOUCHED', (15,40), cv2.FONT_HERSHEY_DUPLEX, 1.5, (255, 255, 255), 1)
